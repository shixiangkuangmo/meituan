...
function watchLogs(v){
  setTimeout(() => {
    if(v != cookies.length*qqTimes){
      ...
      sendNotify.sendNotify("美团25-12 10点通知:",msgstr);
    }
  }, 100);
}
let intervals = [];
            ...
            axios
              ...
              .then((answer) => {
                ...
                if(answer.data.msg.indexOf("成功")>-1){
                  ...
                  ee.setEnvVar("mt_sq25_12_10",headers["Cookie"]);
...
autoCheck.autoCheck("mt_sq25_12_10","美团25-12 10点通知").then((res)=>{
  ck = process.env["mt_sq25_12_10"] || "";
  if(ck != "")
    getCookies();
});
